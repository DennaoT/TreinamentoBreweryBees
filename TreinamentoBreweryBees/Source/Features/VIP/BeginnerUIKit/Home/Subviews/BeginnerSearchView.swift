...
protocol BeginnerSearchDisplaying: AnyObject {
    func display()
}

final class BeginnerSearchView: UIView {
...
extension BeginnerSearchView: BeginnerSearchDisplaying {
    func display() {
        //Something
    }
}
